...
-- Volcando estructura de base de datos para northwind_db
CREATE DATABASE IF NOT EXISTS `northwind_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `northwind_db`;

-- Volcando estructura para tabla northwind_db.categories
...
-- Volcando estructura para tabla northwind_db.customers
...
-- Volcando datos para la tabla northwind_db.customers: ~91 rows (aproximadamente)
...
-- Volcando estructura para tabla northwind_db.employees
...
-- Volcando datos para la tabla northwind_db.employees: ~10 rows (aproximadamente)
...
-- Volcando estructura para tabla northwind_db.orderdetails
...
-- Volcando datos para la tabla northwind_db.orderdetails: ~518 rows (aproximadamente)
...
-- Volcando estructura para tabla northwind_db.orders
...
-- Volcando datos para la tabla northwind_db.orders: ~196 rows (aproximadamente)
DELETE FROM `orders`;
...
-- Volcando estructura para tabla northwind_db.products
...
-- Volcando datos para la tabla northwind_db.products: ~77 rows (aproximadamente)
...
-- Volcando estructura para tabla northwind_db.shippers
...
-- Volcando datos para la tabla northwind_db.shippers: ~3 rows (aproximadamente)
...
-- Volcando estructura para tabla northwind_db.suppliers
...
-- Volcando datos para la tabla northwind_db.suppliers: ~29 rows (aproximadamente)
